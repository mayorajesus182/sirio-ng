...
@Component({
  ...
  styleUrls: ['./nota-table.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  animations: [fadeInUpAnimation, fadeInRightAnimation]
})

export class NotaTableComponent extends TableBaseComponent implements OnInit, AfterViewInit {
  esGerente: Boolean = false;
  displayedColumns = ['tipo_nota', 'cliente', 'monto', 'serial', 'activo', 'actions'];
  constructor(
    injector: Injector,
