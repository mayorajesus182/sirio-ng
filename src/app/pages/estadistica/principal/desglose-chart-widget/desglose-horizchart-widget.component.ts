...
@Component({
  selector: 'sirio-principal-horizchart-widget',
  templateUrl: './desglose-horizchart-widget.component.html',
  styleUrls: ['./desglose-horizchart-widget.component.scss']
})
export class PrincipalHorizChartWidgetComponent extends ChartBaseComponent implements OnInit  {
