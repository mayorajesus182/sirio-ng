...
@Component({
  ...
  templateUrl: './trans-barhoriz-chart-widget.component.html',
  styleUrls: ['./trans-barhoriz-chart-widget.component.scss']
})
export class TransBarHorizChartWidgetComponent extends ChartBaseComponent implements OnInit  {
