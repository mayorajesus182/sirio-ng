...
@Component({
  ...
  selector: 'sirio-trans-barvert-chart-widget',
  templateUrl: './trans-barvert-chart-widget.component.html',
  styleUrls: ['./trans-barvert-chart-widget.component.scss']
})
export class TransBarVertChartWidgetComponent extends ChartBaseComponent implements OnInit {
