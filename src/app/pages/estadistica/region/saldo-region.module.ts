...
import { AgenciaWidgetTableComponent } from './table-widget/agencia-widget-table.component';
...
@NgModule({
  ...
  declarations: [SaldoRegionComponent,RegionVertChartWidgetComponent,AgenciaWidgetTableComponent],
  exports:[],
})
