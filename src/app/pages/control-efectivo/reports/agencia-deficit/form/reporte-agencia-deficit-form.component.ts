...
@Component({
    selector: 'app-reporte-agencia-deficit-form',
    templateUrl: './reporte-agencia-deficit-form.component.html',
    styleUrls: ['./reporte-agencia-deficit-form.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    animations: [fadeInUpAnimation, fadeInRightAnimation]
})

export class ReporteAgenciaDeficitFormComponent extends FormBaseComponent implements OnInit {
    ...
    generate() {
        ...
        this.gestionEfectivoReportsService.agenciaDeficit(this.gestionEfectivoReports).subscribe(data => {
