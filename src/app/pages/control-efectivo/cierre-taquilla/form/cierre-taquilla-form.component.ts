...
export class CierreTaquillaFormComponent extends FormBaseComponent implements OnInit, AfterViewInit {
    ...
    calculateDifferences(saldoTaquilla: SaldoTaquilla) {
        ...
        if (saldoTaquilla.moneda === this.preferencias.monedaConoActual.value) {
            ...
            if (Math.abs(saldoTaquilla.declarado - saldoTaquilla.saldo) > this.preferencias.ajusteTaquilla.value) {

                let ajuste = saldoTaquilla.declarado > saldoTaquilla.saldo ? (this.preferencias.ajusteTaquilla.value * -1) : this.preferencias.ajusteTaquilla.value;
            ...
            } else if (Math.abs(saldoTaquilla.declarado - saldoTaquilla.saldo) > 0 && Math.abs(saldoTaquilla.declarado - saldoTaquilla.saldo) <= this.preferencias.ajusteTaquilla.value) {
