...
import { RecibirRemesaRoutingModule } from './recibir-remesa-routing.module';
...
@NgModule({
    imports: [
        ...
        HighlightModule,
        SirioCardModule,
        RecibirRemesaRoutingModule,
    ],
    declarations: [
        RecibirRemesaTableComponent,
        RecibirRemesaFormComponent
    ],
    exports: [],
})

export class RecibirRemesaModule {
