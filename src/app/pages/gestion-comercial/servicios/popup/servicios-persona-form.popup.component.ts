...
@Component({
  selector: 'sirio-servicios-persona-form.popup',
  templateUrl: './servicios-persona-form.popup.component.html',
  styleUrls: ['./servicios-persona-form.popup.component.scss']
})
export class ServiciosPersonaFormPopupComponent extends PopupBaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    ...
    dialogRef: MatDialogRef<ServiciosPersonaFormPopupComponent>,
