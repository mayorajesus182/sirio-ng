...
import {
    AccionistaDirectivo,
    AccionistaDirectivoService
} from 'src/@sirio/domain/services/persona/accionista-directivo/accionista-directivo.service';
import {TableBaseComponent} from 'src/@sirio/shared/base/table-base.component';
import {AccionistaDirectivoFormPopupComponent} from '../popup/accionista-directivo-form.popup.component';
import {PepAccionista} from '../../../../../@sirio/domain/services/persona/pep-accionista/pep.service';
...
export class AccionistaDirectivoTableComponent extends TableBaseComponent implements OnInit, AfterViewInit {
    ...
    popup(data?: AccionistaDirectivo) {
        ...
        this.showFormPopup(AccionistaDirectivoFormPopupComponent, !data ? {
            persona: this.persona,
            porcentajeAccionario: this.porcentajeAccionario,
            accionistas: this.accionistas,
            Tipopersona: this.Tipopersona
        } : {...data, ...{accionistas: this.accionistas}}, '70%').afterClosed().subscribe(event => {
            if (event) {
