...
import { PlazoFijoRoutingModule } from './plazo-fijo-routing.module';
...
@NgModule({
    imports: [
        ...
        HighlightModule,
        SirioCardModule,
        PlazoFijoRoutingModule
    ],
    declarations: [
        PlazoFijoFormComponent,
        PlazoFijoTableComponent,
        PlazoFijoDetailComponent
    ],
    exports: [],
})
