...
import { TipoPepRoutingModule } from './tipo-pep-routing.module';
...
@NgModule({
    imports: [
        ...
        HighlightModule,
        SirioCardModule,
        TipoPepRoutingModule
    ],
    declarations: [
        TipoPepFormComponent,
        TipoPepTableComponent,
        TipoPepDetailComponent
    ],
    exports: [],
})

export class TipoPepModule {
