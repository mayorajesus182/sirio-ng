...
export class EstatusPersonaFormComponent extends FormBaseComponent implements OnInit {
    ...
    estado: EstatusPersona = {} as EstatusPersona;
    ...
    constructor(
        ...
        private estadoService: EstatusPersonaService,
    ...
    ngOnInit() {
        ...
        if (id) {
            this.estadoService.get(id).subscribe((agn: EstatusPersona) => {
                this.estado = agn;
    ...
    buildForm(estado: EstatusPersona) {
    ...
    save() {
        ...
        this.saveOrUpdate(this.estadoService, this.estado, 'El Estatus de Persona', this.isNew);
    }
