...
import { EstatusPersonaRoutingModule } from './estatus-persona-routing.module';
...
@NgModule({
    imports: [
        ...
        HighlightModule,
        SirioCardModule,
        EstatusPersonaRoutingModule
    ],
    declarations: [
        EstatusPersonaFormComponent,
        EstatusPersonaTableComponent,
        EstatusPersonaDetailComponent
    ],
    exports: [],
})

export class EstatusPersonaModule {
