...
import { ClaseTelefonoRoutingModule } from './clase-telefono-routing.module';
...
@NgModule({
    imports: [
        ...
        HighlightModule,
        SirioCardModule,
        ClaseTelefonoRoutingModule
    ],
    declarations: [
        ClaseTelefonoFormComponent,
        ClaseTelefonoDetailComponent,
        ClaseTelefonoTableComponent
    ],
    exports: [],
})

export class ClaseTelefonoModule {
