...
export type Theme = 'sirio-default' | 'sirio-light' | 'sirio-dark' | 'sirio-flat';
...
export class ThemeService {
  ...
  private _themeSubject = new BehaviorSubject<[Theme, Theme]>([null, 'sirio-default']);
  ...
  setStyle(style: 'default' | 'flat' | 'dark' | 'light' | 'top' | string) {
    switch (style) {
      case 'flat': {
        ...
        this.setTheme('sirio-flat');
        break;
      }

      case 'dark': {
        this.setTheme('sirio-dark');
        break;
      }
